...
if(number > 5)                                      // number is indeed greater than 5 (true)
...
if(temperature > 30)                                // if temperature is greater than 30       
    ...
    console.log("It is a cool day!");               // print "It is a cool day"
...
switch (expression) {                               
    ...
    case "case3":
        ...
        break;
    default:                                        // This default statement is a catch-all block
        // default code block                       
...
/* 
* Converting the if - else if - else code block using switch-case statement
*/
...
console.log(j >= k);               // 10 >= 20 false
console.log(j == k);               // 10 == 20 false
console.log(j === k);              // 10 === 20 false (checking against the value AND the type) 
console.log(j != k);               // 10 != 20 true
console.log(j !== k);              // 10 !== 20 true
...
/* 
* https://www.fadzilshop.com?product=productA&quantity=3 
